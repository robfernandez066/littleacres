...
export const LONG_QUESTS: readonly LongQuestDef[] = [
  {
    id: 'golden_fields',
    name: 'Golden Fields',
    description: 'Harvest 1000 Sunwheat over the life of your farm.',
  ...
  },
  {
    id: 'star_farmer',
    name: 'Star Farmer',
    description: 'Harvest 100 Starcorn over the life of your farm.',
  ...
  },
  {
    ...
    description: 'Harvest 50 Glowberries over the life of your farm.',
  ...
  },
  {
    ...
    description: 'Fulfill 100 villager orders.',
  ...
  },
  {
    ...
    description: 'Fulfill 10 premium orders.',
  ...
  },
  {
    id: 'deep_roots',
    name: 'Deep Roots',
    description: 'Harvest 1500 crops of any kind over the life of your farm.',
...
export const WEEKLY_QUESTS: readonly WeeklyQuestDef[] = [
  ...
  },
  {
    id: 'weekly_trader',
    name: 'Weekly Trader',
    description: 'Fulfill 20 orders this week.',
    counter: { kind: 'orders' },
    target: 20,
    reward: { moondust: 3 },
  ...
  },
  {
    ...
    description: 'Harvest 8 Radiant crops this week.',
...
export const GROWTH_TARGETS_BY_LEVEL: readonly number[] = [
  200, 400, 1000, 4000, 5000, 5000, 10_000, 10_000,
];
