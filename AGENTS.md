# AGENTS.md - Little Acres (Developer Guide)
...
Documentation review exception: When the user explicitly requests a read-only game review, Codex may read named files under docs/. Codex must not modify those files.
